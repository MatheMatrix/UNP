...
| ----- | --- | --- |
| 分布式路由 | 无 | 提供，默认支持 |
| 虚拟路由高可用 | 基于消息队列 | 对分布式路由器提供 Pacemaker 高可用，对于集中式路由器提供 VRRP 高可用 |
...
| 消息队列 | 可靠性低 | 预期有所提升，暂未完成，本 Release 完成 |
